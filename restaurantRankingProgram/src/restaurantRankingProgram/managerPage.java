...
public class managerPage extends JFrame {
	...
	/*manager page for processing the requests of users*/
	public managerPage() {
		...
		listContent.setEditable(false); //prohibiting the edit functions
		JScrollPane scrollPane1 = new JScrollPane(listContent);//adding the scroll bar
		...
		answerContent = new JTextArea(); //writing the answer comments
		...
		saveBtn = new JButton("SAVE"); //buttons for storing the answer comments
	...
	/*function for writing the answer comments to the answer file*/
	public void writeText() {
		try {
            ...
            if (file.exists()) {
                ...
                fileWriter = new FileWriter(file); // creating new file
            }
